...
<head>
    ...
    <title>Tambah Dosen - Dark Mode</title>
    <style>
        ...
        .form-control:focus { background-color: #0f172a; border-color: #3b82f6; color: #fff; box-shadow: 0 0 0 0.25rem rgba(59, 130, 246, 0.25); }

        /* --- PERBAIKAN TOMBOL DISINI --- */
        .buttons-wrap {
            display: flex;      /* Sejajar Kanan-Kiri */
            gap: 15px;          /* Jarak antar tombol */
            margin-top: 30px;
        }
        .btn-submit, .btn-cancel {
            flex: 1;            /* Lebar dibagi rata 50:50 */
            padding: 12px;
            border-radius: 50px;
            font-weight: bold;
            text-align: center;
...
<body>
    ...
    <div class="container mb-5">
        <div class="form-wrapper">
            <h2 class="page-title">TAMBAH DOSEN BARU</h2>
            
            <form method="post" action="index.php?mod=lecturer&act=create">
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="phone" class="form-control" placeholder="081xxxx" required>
                </div>
                <div class="mb-3">
