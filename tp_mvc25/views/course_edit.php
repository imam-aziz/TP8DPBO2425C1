...
<head>
    ...
    <title>Edit Matkul - Dark Mode</title>
    <style>
        ...
        .form-control:focus, .form-select:focus { background-color: #0f172a; border-color: #facc15; color: #fff; box-shadow: 0 0 0 0.25rem rgba(250, 204, 21, 0.25); }
...
<body>
    ...
    <div class="container mb-5">
        <div class="form-wrapper">
            ...
            <form method="post" action="index.php?mod=course&act=edit&id=<?= $data['id'] ?>">
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="credits" value="<?= $data['credits'] ?>" class="form-control" required>
                </div>
                <div class="mb-3">
                    <label>Dosen Pengajar</label>
                    <select name="lecturer_id" class="form-select" required>
                        <?php foreach ($lecturers as $lec): ?>
                            <option value="<?= $lec['id'] ?>" <?= ($lec['id'] == $data['lecturer_id']) ? 'selected' : '' ?>>
                                <?= $lec['name'] ?>
                            </option>
                        <?php endforeach; ?>
                    </select>
